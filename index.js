...
var words = ["BIGLY", "TREMENDOUS", "CHINA", "LOSER", "RUSSIA", "MIKE PENCE", "WRONG. WRONG. WRONG.", "IVANKA", "BUILD THE WALL", "MEXICO", "FAKE NEWS", "PUTIN","NASTY WOMAN", "GRAB THEM BY THE PUSSY", "WINNING", "VERY BAD", "HUGE", "TERRIFIC", "KELLYANNE CONWAY", "WE ARE THE BEST ADMINISTRATION", "FAT LOSER", "TAX RETURNS", "ORANGE", "KANYE", "AUSTRALIA", "TINY HANDS", "MAKE AMERICA GREAT AGAIN", "TWITTER", "INTERNET TROLL", "BAD HOMBRES", "BILLIONAIRE", "BIGGEST INAUGURATION CROWD IN HISTORY", "ALTERNATIVE FACTS", "MELANIA", "MICROPENIS", "BANKRUPTCY", "YOU'RE FIRED", "THE APPRENTICE", "WOMEN: FAT PIGS, DOGS, SLOBS", "ROSIE O'DONNELL", "SNIFF SNIFF", "HAIR", "TOTAL DISASTER"];
